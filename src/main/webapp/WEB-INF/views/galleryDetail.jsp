...
<html lang="ko">
    <head>
        ...
        <script type="text/javascript">
	        ...
	        function deleteGallery(no) {
	        	Swal.fire({
			        title: "gallery post 삭제",
			        //text: "글을 삭제합니다.",
			        icon: "warning",
			        ...
			        if (result.isConfirmed) {
			       	  ...
			       	  vform.append($('<input/>', {type:'hidden', name: 'no', value:${detail.gno}})); //값 붙여주기~
        ...
        <section class="page-section" id="gallery">
            <div class="container"> <!-- justify-content-center --> 
            	<div class="text-center">
            		<h2 class="section-heading text-uppercase">Gallery Details</h2>
                </div>
                <div class="card mb-4" style="min-height:500px;">
                	<div class="card-body">
                		<div class="h2">${detail.gtitle }</div>
                		...
                		<div class="mt-4 min-vh-75">
                		<img alt="갤러리이미지" src="./upfile/${detail.gfile }">
                		<div>${detail.gcontent }</div>
                		</div>
                	</div>
                </div>
        		<button class="btn btn-light" onclick="history.back()">to gallery</button>
