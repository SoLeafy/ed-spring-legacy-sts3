    ...
    <head>
        ...
        <script type="text/javascript">
	        ...
	        function galleryDetail(no) {
	        	...
	        	location.href="./galleryDetail@"+no; //path variable 써먹기
	        }
        </script>
    </head>
    <body id="page-top">
        ...
        <section class="page-section" id="gallery">
  					...
  					<div class="col-sm-3 mb-2">
		            	...
		            	<div class="card-title">
		            		...
		            		<div class="card-group row">
		            			...
		            			<img alt="glike" src="/img/likes.png">
		            			${row.glike }
		            			</div>
            ...
            <div class="btnWrapper">
				<button class="btn btn-outline-warning" type="submit" onclick="location.href='./galleryInsert'">글쓰기</button>
            </div>
            </div>
        </section>
        <!-- Bootstrap core JS-->
